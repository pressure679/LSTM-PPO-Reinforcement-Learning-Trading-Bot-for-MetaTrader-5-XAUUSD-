...
def add_indicators(df):
    ...
    df["bullish_fib382"], df["bullish_fib500"], df["bullish_fib618"], _, df["bearish_fib382"], df["bearish_fib500"], df["bearish_fib618"], _ = Fibonacci(df)
    ...
    df = df[["Open", "High", "Low", "Close",
            ...
            "bullish_fib382", "bullish_fib500", "bullish_fib618", "bearish_fib382", "bearish_fib500", "bearish_fib618",
